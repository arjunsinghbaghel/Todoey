...
//    MARK - Model Manupulation Methods
    ...
    func loadItems(with request:NSFetchRequest<Item> = Item.fetchRequest(), predicate:NSPredicate? = nil){
        ...
        if let addtionalPridicate = predicate{
            request.predicate = NSCompoundPredicate(andPredicateWithSubpredicates: [categoryPerdicate, addtionalPridicate])
        }else{
...
extension TodolistListViewController: UISearchBarDelegate{
